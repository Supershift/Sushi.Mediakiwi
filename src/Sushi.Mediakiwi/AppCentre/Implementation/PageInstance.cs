...
namespace Sushi.Mediakiwi.AppCentre.Data.Implementation
{
    ...
    public class PageInstance : BaseImplementation
    {
        ...
        public PageInstance()
        {
            ...
            this.ListLoad += new ComponentListEventHandler(PageInstance_ListLoad);
            this.ListSave += new ComponentListEventHandler(PageInstance_ListSave);
        }

        void PageInstance_ListSave(object sender, ComponentListEventArgs e)
        {
            ...
            if (e.SelectedKey == 0)
            {
                ...
                if (this.IsOverview)
                {
                    ...
                    folder.Name = name;
                    folder.ParentID = wim.CurrentFolder.ID;
                    folder.Type = wim.CurrentFolder.Type;
                    folder.SiteID = wim.CurrentFolder.SiteID;

                    if (string.IsNullOrEmpty(wim.CurrentFolder.CompletePath))
                        folder.CompletePath = string.Concat("/", name, "/");
                    else
                        folder.CompletePath = string.Concat(wim.CurrentFolder.CompletePath, name, "/");
                    ...
                    Sushi.Mediakiwi.Framework.Inheritance.Folder.CreateFolder(folder, wim.CurrentSite);
                }

                
                m_Implement.Name = name;
                m_Implement.LinkText = this.Name2.Trim();
                m_Implement.Title = this.Name2.Trim();
            ...
            Sushi.Mediakiwi.Framework.Functions.FolderPath.UpdateCompletePath(m_Implement.FolderID);
            Sushi.Mediakiwi.Data.EnvironmentVersionLogic.Flush();
            //Wim.Utilities.CacheItemManager.FlushAllPageStructureData(HttpContext.Current);
            //m_Implement.SubmitPageForSearch();

            Response.Redirect(string.Concat(wim.Console.WimPagePath, "?page=", masterId), false);
        }

        Sushi.Mediakiwi.Data.Page m_Implement;
        void PageInstance_ListLoad(object sender, ComponentListEventArgs e)
        {
            m_Implement = Sushi.Mediakiwi.Data.Page.SelectOne(e.SelectedKey, false);
            Utility.ReflectProperty(m_Implement, this);
            
            //if (e.SelectedKey == 0)
            //    this.FolderID = Wim.Utility.ConvertToInt(Request.QueryString["FolderID"]);
        ...
        [Sushi.Mediakiwi.Framework.OnlyVisibleWhenTrue("IsNotNew")]
        [Sushi.Mediakiwi.Framework.ContentListItem.TextField("_name", 150, true, null, Wim.Utility.GlobalRegularExpression.OnlyAcceptableFilenameCharacter)]
        ...
        [Sushi.Mediakiwi.Framework.OnlyVisibleWhenTrue("IsNotNew", false)]
        ...
        [Sushi.Mediakiwi.Framework.OnlyVisibleWhenTrue("IsNotNew")]
        [Sushi.Mediakiwi.Framework.ContentListItem.TextField("_linktext", 150, false, "When used to link to this value is shown")]
        ...
        [Sushi.Mediakiwi.Framework.OnlyVisibleWhenTrue("IsNotNew")]
        //[Sushi.Mediakiwi.Framework.OnlyEditableWhenTrue("IsNotInherited")]
        [Sushi.Mediakiwi.Framework.ContentListItem.FolderSelect("_subfolder", false)]
        ...
        [Sushi.Mediakiwi.Framework.OnlyVisibleWhenTrue("IsNotNew")]
        [Sushi.Mediakiwi.Framework.ContentListItem.Choice_Checkbox("_is_searchable", "Is this page indexed by searchenigines?")]
        ...
        /// <value>The template.</value>
        [Sushi.Mediakiwi.Framework.OnlyVisibleWhenTrue("IsNotNew")]
        [Sushi.Mediakiwi.Framework.ContentListItem.Choice_Checkbox("_is_default", "Is dit de standaard pagina in de huidige folder?")]
        ...
        /// </summary>
        /// <value>The template.</value>
        [Sushi.Mediakiwi.Framework.OnlyEditableWhenTrue("IsTemplateEditable")]
        ...
        /// </value>
        [Sushi.Mediakiwi.Framework.OnlyVisibleWhenTrue("IsNotNew", false)]
        [Sushi.Mediakiwi.Framework.ContentListItem.Choice_Checkbox("Is overzicht", "Is dit een overzichtspagina met subnavigatie?")]
        public bool IsOverview { get; set; }

        /// <summary>
        /// Gets a value indicating whether this instance is template editable.
        /// </summary>
        /// <value>
        /// 	<c>true</c> if this instance is template editable; otherwise, <c>false</c>.
        /// </value>
        public bool IsTemplateEditable
        {
            get { return m_TemplateID == 0; }
        }
        ...
        public ListItemCollection TemplateList
        {
            get
            {
                ...
                foreach (Sushi.Mediakiwi.Data.PageTemplate template in Sushi.Mediakiwi.Data.PageTemplate.SelectAllSortedByName())
                {
                    ...
                    if (IsTemplateEditable && template.OnlyOneInstancePossible && template.PageInstanceCount > 0) continue;
        ...
        [Sushi.Mediakiwi.Framework.OnlyVisibleWhenTrue("IsNotNew")]
        [Sushi.Mediakiwi.Framework.ContentListItem.TextField("Browser title", 250, false)]
        public string Title
        {
            get { return m_Title; }
            set { m_Title = value; }
        ...
        /// <value>The template.</value>
        [Sushi.Mediakiwi.Framework.OnlyVisibleWhenTrue("IsNotNew")]
        [Sushi.Mediakiwi.Framework.ContentListItem.DateTime("Publication date", false, "If applided the page will be published at this date and time.")]
        ...
        /// <value>The template.</value>
        [Sushi.Mediakiwi.Framework.OnlyVisibleWhenTrue("IsNotNew")]
        [Sushi.Mediakiwi.Framework.ContentListItem.DateTime("Expiration date", false, "If applided the page will expire at this date and time.")]
