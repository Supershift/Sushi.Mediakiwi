    ...
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(4, 'Sushi.Mediakiwi.Framework.dll', 'Sushi.Mediakiwi.AppCentre.Data.Implementation.Copy', 2, 'Copy', 'Copy', null, null, '1FC0AA4D-A38F-4E29-AF49-996DDD31936A', 0, 1, 0);
    ...
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(4, 'Sushi.Mediakiwi.Framework.dll', 'Sushi.Mediakiwi.AppCentre.Data.Implementation.CopyContent', 2, 'Copy page content', 'Copy page content', null, null, 'a1c0c71c-A38F-4E29-AF49-996DDD31936A', 0, 1, 0);

	-- Page history list;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = 'b1c0c71c-A38F-4E29-AF49-996DDD31936A';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(4, 'Sushi.Mediakiwi.Framework.dll', 'Sushi.Mediakiwi.AppCentre.Data.Implementation.PageHistory', 2, 'Page History', 'Page History', null, null, 'b1c0c71c-A38F-4E29-AF49-996DDD31936A', 0, 1, 0);
