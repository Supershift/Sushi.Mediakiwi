...
{
    /// <summary>
    /// Represents the ODBC data command wrapper.
    /// </summary>
    public class OdbcCommander : IDisposable
    {
        private OdbcCommand m_Command;
        private OdbcParameter m_Parameter;
        ...
        private OdbcConnect _connect;
        /// <summary>
        /// Gets or sets the connect.
        /// </summary>
        /// <value>The connect.</value>
        public OdbcConnect Connect
        {
        ...
        public OdbcCommander(OdbcConnect connect)
        {
        ...
        /// Initializes a new instance of the <see cref="SqlCommander"/> class.
        /// </summary>
        public OdbcCommander() : this( string.Empty ) {}

        /// <summary>
        /// Initializes a new instance of the <see cref="SqlCommander"/> class.
        /// </summary>
        /// <param name="connection">The connection.</param>
        public OdbcCommander( string connection ) : this( connection, string.Empty, CommandType.Text ) {}
        ...
        public OdbcCommander(string connection, string SqlText, CommandType type)
        {
            if ( this.Connect == null )
                this.Connect = new OdbcConnect();
        ...
        private void SetEnvironment()
        {
            ...
            this.m_Command = new OdbcCommand( this.SqlText, this.Connect.Connection );
        ...
        /// </summary>
        public void SetParameterOutput(string name, OdbcType type)
        {
        ...
        /// Set Sqlparameter as output value
        /// </summary>
        public void SetParameterOutput(string name, OdbcType type, int length)
        {
        ...
        /// Set Sqlparameter as output value
        /// </summary>
        public void SetParameterOutput( string name, OdbcType type, int length, byte scale )
        {
        ...
        /// </summary>
        public void SetParameterInput(string name, OdbcType type)
        {
        ...
        /// Set Sqlparameter as input value
        /// </summary>
        public void SetParameterInput(string name, object itemvalue, OdbcType type)
        {
        ...
        /// Set Sqlparameter as input value
        /// </summary>
        public void SetParameterValidationInput(string name, object itemvalue, OdbcType type)
        {
        ...
        /// </returns>
        private bool IsItemBlankValue(object itemvalue, OdbcType type)
        {
            switch( type )
            {
        ...
        /// Set Sqlparameter as input value
        /// </summary>
        public void SetParameterInput(string name, object itemvalue, OdbcType type, int length)
        {
        ...
        /// Set Sqlparameter as input value
        /// </summary>
        public void SetParameterValidationInput(string name, object itemvalue, OdbcType type, int length)
        {
        ...
        /// Set Sqlparameter as input value
        /// </summary>
        public void SetParameterInput(string name, object itemvalue, OdbcType type, int length, byte scale)
        {
        ...
        /// Set Sql parameter
        /// </summary>
        public void SetParameter(string name, object itemvalue, OdbcType type, int length, ParameterDirection direction)
        {
        ...
        public void SetParameter( string name, object itemvalue, OdbcType type, int length, byte scale, ParameterDirection direction )
        {
            this.SetEnvironment();
...
//                this._actualQuery = this._actualQuery.Replace( name, string.Format( "{0}", itemvalue ) );
        ...
        public OdbcDataReader ExecReader
        {
            get
            {
                this.SetEnvironment();
        ...
        /// <returns></returns>
        public OdbcDataReader ExecReaderCommand(CommandBehavior behavior)
        {
            this.SetEnvironment();
            try
            {
        ...
        public DataSet ExecAdapter
        {
            get
            {
                ...
                try
                {
                    ...
                    OdbcDataAdapter sqlAdapter = new OdbcDataAdapter(this.m_Command);
                    sqlAdapter.Fill( ds );
                    return ds;
                }
                catch ( Exception ex )
