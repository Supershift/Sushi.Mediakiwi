        ...
        options: {
            ...
            add: function (e, data) {
                ...
                data.context = that._renderUpload(data.files)
                    .appendTo($(this).find('.files')).show().data('data', data);
                //  .appendTo($(this).find('.files')).fadeIn(function () { $(this).show(); }).data('data', data);
            ...
            // Callback for successful uploads:
                ...
                if (data.context) {
                    data.context.each(function (index) {
                        ...
                        var input = $('#assets').val();
                        if (input != '')
                            input = input + ',';
                        input += data.result.files[0].ID;
...
//                                });
            ...
            stop: function () {
                $(this).find('.fileupload-progressbar');
                //  Added for Mediakiwi
                var u = location.href += '&col=' + $('#assets').val();
                location.replace(u);
