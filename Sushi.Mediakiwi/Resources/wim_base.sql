    ...
    CREATE TABLE wim_Tasks(
	    Task_Key int IDENTITY(1,1) NOT NULL,
	    Task_Description nvarchar(50) NULL,
	    Task_IsActive bit NOT NULL,
	    Task_CompleteOnPublication bit NOT NULL,
	    Task_CompleteOnChange bit NOT NULL,
	    Task_CompleteOnTakeDown bit NOT NULL,
	    Task_CompleteViaButton bit NOT NULL,
	    Task_InheritencePost bit NOT NULL,
	    Task_Message nvarchar(500) NULL);
	    
    --PK_Task_Key;
	IF:select COUNT(*) from sys.indexes where name = 'PK_Task_Key';    
	THEN:ALTER TABLE wim_Tasks WITH NOCHECK ADD CONSTRAINT PK_Task_Key PRIMARY KEY CLUSTERED (Task_Key);
    ...
    CREATE TABLE wim_TaskNotes(
	    TaskNote_Key int IDENTITY(1,1) NOT NULL,
	    TaskNote_User_Key int NOT NULL,
	    TaskNote_Task_Key int NOT NULL,
	    TaskNote_Page_Key int NULL,
	    TaskNote_Completed_User_Key int NULL,
	    TaskNote_IsCompleted bit NOT NULL,
	    TaskNote_Completed datetime NULL,
	    TaskNote_Comment text NULL,
	    TaskNote_Created datetime NOT NULL,
	    TaskNote_NotifyOwner bit NOT NULL);
	    
    --PK_TaskNote_Key;
	IF:select COUNT(*) from sys.indexes where name = 'PK_TaskNote_Key';    
	THEN:ALTER TABLE wim_TaskNotes WITH NOCHECK ADD CONSTRAINT PK_TaskNote_Key PRIMARY KEY CLUSTERED (TaskNote_Key);
    ...
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(3, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.User', 2, 'Users', 'User', null, 1, '9870FA8F-D9B5-47ED-89AE-CF01B6D00591', 1, 1, 0);
    
    -- Role;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '770DBAEA-19A9-48E0-B3D0-B2E8630C4F99';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(3, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.Role', 2, 'Roles', 'Role', null, 2, '770DBAEA-19A9-48E0-B3D0-B2E8630C4F99', 1, 1, 0);

    -- Site;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '18B297DC-7E01-404D-BC45-BB3EA3EB344E';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(4, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.Site', 2, 'Channels', 'Channel', null ,3, '18B297DC-7E01-404D-BC45-BB3EA3EB344E', 1, 1, 0);

    -- Image;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = 'f6252c60-cff3-4c8b-922e-f1d1299cca43';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(null, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.Image', 2, 'Images', 'Image', null, 4, 'f6252c60-cff3-4c8b-922e-f1d1299cca43', 0, 1, 0);

    -- Link;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '161B60C4-75A6-4B54-A710-1E1691F738B4';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(null, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.Link', 2, 'Links', 'Link', null, 5, '161B60C4-75A6-4B54-A710-1E1691F738B4', 0, 1, 0);
	
	-- Code Plus
	IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '793C9C8B-8713-4556-AB68-D284F81E187F';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(null, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.CodePlus', 2, 'Codelplus', 'Codelplus', null, null, '793C9C8B-8713-4556-AB68-D284F81E187F', 0, 1, 0);
    
	-- Document;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = 'B1F5989B-2237-4B45-AA7B-917E3979E95E';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(null, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.Document', 2, 'Documents', 'Document', null, 6, 'B1F5989B-2237-4B45-AA7B-917E3979E95E', 0, 1, 0);

    -- ComponentTemplate;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = 'A0D67C61-0FEE-4F96-86E7-CDD53D89DC43';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(2, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.ComponentTemplate', 2, 'Component templates', 'Template', null, 8, 'A0D67C61-0FEE-4F96-86E7-CDD53D89DC43', 1, 1, 0);

    -- ComponentList;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '814FBDCD-7823-4EF1-8DD5-A347D8FDC090';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(2, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.ComponentList', 2, 'Component lists', 'Template', null, 9, '814FBDCD-7823-4EF1-8DD5-A347D8FDC090', 1, 1, 0);

    -- PageTemplate;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '5017D373-C45D-4C8F-8276-BE881FA08BD6';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(2, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.PageTemplate', 2, 'Page templates', 'Template', null, 10, '5017D373-C45D-4C8F-8276-BE881FA08BD6', 1, 1, 0);

	-- Installer;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '3b8fe32a-7a82-45f6-8fa5-75b52cd1499a';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(2, 'Wim.Framework.dll', 'Wim.AppCentre.UI.InstallerList', 2, 'Installed modules', 'Module', null, null, '3b8fe32a-7a82-45f6-8fa5-75b52cd1499a', 1, 1, 0);

    -- Notification;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = 'B2F79749-2F07-4383-9B75-665AE4B46D71';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(5, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.Notification', 2, 'Notifications', 'Notification', null, 11, 'B2F79749-2F07-4383-9B75-665AE4B46D71', 1, 1, 0);

    -- Environment;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '503f862b-16c3-486b-9558-3e006058c624';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(4, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.Environment', 2, 'Environments', 'Environment', null, 13, '503f862b-16c3-486b-9558-3e006058c624', 1, 1, 0);

    -- Task;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '07FA3600-A044-4609-835E-70E7134744E6';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(5, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.Task', 2, 'Tasks', 'Task', null, 14, '07FA3600-A044-4609-835E-70E7134744E6', 1, 1, 0);

    -- TaskInbox;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = 'C3D02B9D-3BD9-4506-9466-B4583AFD2275';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(5, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.TaskInbox', 2, 'Task inbox', 'Task', null, 16, 'C3D02B9D-3BD9-4506-9466-B4583AFD2275', 1, 1, 0);

    -- TaskOutbox;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = 'A2C82E28-6C19-4B10-BE4E-FBC47988C2A3';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(5, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.TaskOutbox', 2, 'Task outbox', 'Task', null, 17, 'A2C82E28-6C19-4B10-BE4E-FBC47988C2A3', 1, 1, 0);

    -- Folder;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '97292DD5-EBDA-4318-8AAF-4C49E887CDAD';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(null, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.Folder', 2, 'Folders', 'Folder', null, 21, '97292DD5-EBDA-4318-8AAF-4C49E887CDAD', 0, 1, 0);

    -- Browsing;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '0B510F56-83F6-41B8-8C2A-15066024BCD6';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(null, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.Browsing', 2, 'Browsing', 'Browsing', null, 22, '0B510F56-83F6-41B8-8C2A-15066024BCD6', 0, 1, 0);

	-- Export file;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '775b3f09-1c2f-4684-b7bc-da3fa358dc99';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(null, 'Wim.Framework.dll', 'Wim.AppCentre.Data.ExportFile', 2, 'Export file', 'Export file', null, null, '775b3f09-1c2f-4684-b7bc-da3fa358dc99', 0, 1, 0);
    ...
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(null, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.ComponentListInstance', 2, 'List template instance', 'Instance', null, 23, 'D3EB0351-A7BD-460B-8349-1EEF0A2E5771', 0, 1, 0);
    ...
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(null, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.ComponentListProperties', 2, 'List properties', 'properties', null, 24, '1562120C-1C37-49A5-83CD-6B39EBD7F12F', 0, 1, 0);

    -- PageInstance;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '4E7BCF0F-844B-4877-AB2D-3154BE01BC0F';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(null, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.PageInstance', 2, 'Page properties', 'Page', null, 25, '4E7BCF0F-844B-4877-AB2D-3154BE01BC0F', 0, 1, 0);

    -- Dashboard;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = 'DD2F174A-4828-4838-A4D0-3138F844574F';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(4, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.Dashboard', 2, 'Dashboards', 'Dashboard', null, 27, 'DD2F174A-4828-4838-A4D0-3138F844574F', 1, 1, 0);

    -- Property;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '6A7D5E6C-9DAA-4A6F-AEEA-21BD4782DA1E';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(2, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.Property', 1, 'Fields', 'Fields', null, 29, '6A7D5E6C-9DAA-4A6F-AEEA-21BD4782DA1E', 0, 1, 0);

    -- PropertyOption;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '9CA13663-54E0-4701-9658-E2DDDF769F78';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(2, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.PropertyOption', 1, 'Options', 'Options', null, 30, '9CA13663-54E0-4701-9658-E2DDDF769F78', 0, 1, 0);
    ...
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(2, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.PropertySearchColumn', 1, 'Columns', 'Columns', null, 31, 'C7B2C21D-0121-4E58-A0C9-616B31C2E1B1', 0, 1, 0);

    -- ComponentListSense;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '937A7D82-EABD-4747-A74A-7B9106E697B1';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(2, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.ComponentListSense', 2, 'Scheduling', 'Scheduling', null, 32, '937A7D82-EABD-4747-A74A-7B9106E697B1', 0, 1, 0);

    -- ComponentListData;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = 'ABEF9E0A-F5A6-45B7-B812-1B3C861885A0';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(2, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.ComponentListData', 2, 'Data', 'Data', null, 33, 'ABEF9E0A-F5A6-45B7-B812-1B3C861885A0', 0, 1, 0);
    ...
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(2, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.ComponentListSettings', 2, 'Settings', 'Settings', null, 46, '15C30414-F187-4021-B991-386653677767', 0, 1, 0);

    -- Menu;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '3ab5b10f-f4ae-4f61-9db1-7f938ccc4f37';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(4, 'Wim.Framework.dll', 'Wim.AppCentre.Data.MenuList', 2, 'Menu', 'Menu', null, null, '3ab5b10f-f4ae-4f61-9db1-7f938ccc4f37', 1, 1, 0);

	-- Search;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '1a1fe050-219c-4f63-a697-7e2e8e790521';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(4, 'Wim.Framework.dll', 'Wim.AppCentre.Data.BasicSearchList', 2, 'Search', 'Search', null, null, '1a1fe050-219c-4f63-a697-7e2e8e790521', 1, 0, 0);
    ...
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(2, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.GenericExposedListCollection', 1, '_Shared list collections', 'Datalist', null, null, '677C8CD4-9C2F-43A2-9ED8-EDABA06A3F97', 0, 1, 0);

    -- Note list;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '30438020-85D2-4160-B7A9-E8E6A2A53E65';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(null, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.NoteList', 2, 'Note', 'Note', null, 38, '30438020-85D2-4160-B7A9-E8E6A2A53E65', 0, 1, 0);

    -- Subscriptions;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '28C4171D-C219-45EA-A7A8-13D1675F3B25';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(null, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.SubscriptionList', 2, 'Subscription', 'Subscription', null, 39, '28C4171D-C219-45EA-A7A8-13D1675F3B25', 0, 1, 0);

    -- Portal;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '6B515D23-543F-4971-A0DD-E051742C6F94';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(null, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.PortalList', 2, 'Portals', 'Portal', null, 40, '6B515D23-543F-4971-A0DD-E051742C6F94', 0, 1, 0);
    ...
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(null, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.VisitorTrackingExport', 2, 'Export', 'Export', null, 41, 'DE20BC46-4486-45EB-A0B2-5FBDF4B1E485', 0, 1, 0);

    -- Role access list;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = 'B502AA2C-8D85-4D2C-9470-DFC8A388AC72';
    THEN: INSERT INTO wim_ComponentLists (ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(null, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.RoleAccessList', 2, 'Lists', 'Lists', null, 42, 'B502AA2C-8D85-4D2C-9470-DFC8A388AC72', 0, 1, 0);

    -- Role access site;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '93D10F58-6A1A-493F-8ADB-E53FC7CEDE19';
    THEN: INSERT INTO wim_ComponentLists (ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(null, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.RoleAccessSite', 2, 'Sites', 'Sites', null, 43, '93D10F58-6A1A-493F-8ADB-E53FC7CEDE19', 0, 1, 0);

    -- Role access folder;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = 'AB58D901-7305-4584-9133-53FB92684A2C';
    THEN: INSERT INTO wim_ComponentLists (ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(null, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.RoleAccessFolder', 2, 'Folders', 'Folders', null, 44, 'AB58D901-7305-4584-9133-53FB92684A2C', 0, 1, 0);
    
    -- Role access gallery;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '5A7DB5D1-8DCE-4510-8423-47E4925B6C8B';
    THEN: INSERT INTO wim_ComponentLists (ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(null, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.RoleAccessGallery', 2, 'Galleries', 'Galleries', null, 45, '5A7DB5D1-8DCE-4510-8423-47E4925B6C8B', 0, 1, 0);
   
    -- Registry;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = 'D4334EAF-DE8F-4540-9988-2787D09DD50C';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(4, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.RegistryList', 2, 'Registry', 'Registry', null, 36, 'D4334EAF-DE8F-4540-9988-2787D09DD50C', 1, 1, 0);

    -- Page list;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '63c0c71c-e301-4a29-9a75-73874cb6622e';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(4, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.PageList', 2, 'Pagelist', 'Pagelist', null, 28, '63c0c71c-e301-4a29-9a75-73874cb6622e', 1, 0, 0);

	-- Pagemapping list;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = '5dfe77be-a7c3-4494-87b2-f9ffba97ba52';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(4, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.PageMappingList', 2, 'PageMapping', 'PageMapping list', null, null, '5dfe77be-a7c3-4494-87b2-f9ffba97ba52', 0, 1, 0);
    ...
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(4, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.Copy', 2, 'Copy', 'Copy', null, null, '1FC0AA4D-A38F-4E29-AF49-996DDD31936A', 0, 1, 0);
    ...
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(4, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.CopyContent', 2, 'Copy page content', 'Copy page content', null, null, 'a1c0c71c-A38F-4E29-AF49-996DDD31936A', 0, 1, 0);

	-- Page history list;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = 'b1c0c71c-A38F-4E29-AF49-996DDD31936A';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_ContainsOneChild, ComponentList_IsVisible, ComponentList_IsInherited) VALUES(4, 'Wim.Framework.dll', 'Wim.AppCentre.Data.Implementation.PageHistory', 2, 'Page History', 'Page History', null, null, 'b1c0c71c-A38F-4E29-AF49-996DDD31936A', 0, 1, 0);

    -- ComponentListInstance;
    IF: select count(*) from wim_ComponentLists where ComponentList_GUID = 'D03439F0-73D7-4C78-B51E-50310A00F6DA';
    THEN: INSERT INTO wim_ComponentLists(ComponentList_Folder_Key, ComponentList_Assembly, ComponentList_ClassName, ComponentList_TargetType, ComponentList_Name, ComponentList_SingleItemName, ComponentList_Description,ComponentList_Type, ComponentList_GUID, ComponentList_IsVisible, ComponentList_ContainsOneChild, ComponentList_IsInherited) VALUES(null, 'Wim.Framework.dll', 'Wim.AppCentre.UI.WikiList', 2, 'Wiki', 'Wiki', null, null, 'D03439F0-73D7-4C78-B51E-50310A00F6DA', 0, 1, 0);
