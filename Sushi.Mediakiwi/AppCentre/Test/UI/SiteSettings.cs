...
namespace Sushi.Mediakiwi.AppCentre.Data.Test.UI
{
    /// <summary>
    /// 
    /// </summary>
    public class SiteSettings : ComponentListTemplate
    {
        /// <summary>
        ...
        public SiteSettings()
        {
            ...
            this.ListLoad += new ComponentListEventHandler(SiteSettings_ListLoad);
        }

        void SiteSettings_ListLoad(object sender, ComponentListEventArgs e)
        {
        }
        ...
        public SiteSettings(Sushi.Mediakiwi.Data.Site site)
        {
            this.wim.CurrentSite = site;
            ApplyContent(new Guid("cda13af1-64b0-4492-a1c6-f986e871f280"), site);
        }
        ...
        [Sushi.Mediakiwi.Framework.ContentListItem.DateTime("DateTime", true, false, "Helptext for DateTime field")]
