...
namespace Sushi.Mediakiwi.Data
{
    public interface IComponentList
    {
        ...
        string zzChannelInfo { get; set; }
        string zzChannelInfo2 { get; set; }
        string zz_Generics0 { get; set; }
        string zz_Generics1 { get; set; }
        string zz_Generics2 { get; set; }
        string zz_Generics3 { get; set; }

        //Catalog Catalog(WimServerPortal portal = null);
        bool Delete();
        //IComponentListTemplate GetInstance();
        bool HasRoleAccess(IApplicationUser user);
        //bool HasRoleAccess(IApplicationUser user, string portal);
        int Save();
        string Icon { get; set; }
